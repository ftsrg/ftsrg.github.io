...
const getMetaTagByName: Function = (metaName: string) => {
...
const getMetaTagByProperty: Function = (metaProperty: string) => {
...
const getLinkTagByRel: Function = (linkRel: string) => {
...
describe("<SEO />", () => {
  ...
  it("has default description", async () => {
    render(<SEO />);
    await waitFor(() => {
      expect(getMetaTagByName("description")).toEqual(
  ...
  it("has open graph description", async () => {
    render(<SEO />);
    await waitFor(() => {
      expect(getMetaTagByProperty("og:description")).toEqual(
        "Sample website description.",
      );
    });
  });
  ...
  it("has twitter card description", async () => {
    render(<SEO />);
    await waitFor(() => {
      expect(getMetaTagByName("twitter:description")).toEqual(
        "Sample website description.",
      );
    });
  });
  ...
  it("has canonical url", async () => {
    render(<SEO />);
    await waitFor(() =>
      expect(getLinkTagByRel("canonical")).toEqual("https://site.example/"),
    );
  });
  ...
  it("has default open graph image", async () => {
    render(<SEO />);
    await waitFor(() =>
      expect(getMetaTagByProperty("og:image")).toEqual(
  ...
  it("uses custom open graph image", async () => {
    render(
      <SEO image="https://source.unsplash.com/collection/983219/1600x900" />,
    );
    await waitFor(() =>
      expect(getMetaTagByProperty("og:image")).toEqual(
  ...
  it("supports custom, root-relative open graph image", async () => {
    ...
    await waitFor(() =>
      expect(getMetaTagByProperty("og:image")).toEqual(
        "https://site.example/collection/983219/1600x900",
      ),
    );
  });
  ...
  it("has default open graph type", async () => {
    render(<SEO />);
    await waitFor(() =>
      expect(getMetaTagByProperty("og:type")).toEqual("website"),
    );
  });
  ...
  it("has twitter card image", async () => {
    render(<SEO />);
    await waitFor(() =>
      expect(getMetaTagByName("twitter:image")).toEqual(
        "https://source.unsplash.com/collection/983219/2000x1322",
      ),
    );
  });
  ...
  it("uses large twitter cards", async () => {
    render(<SEO />);
    await waitFor(() =>
      expect(getMetaTagByName("twitter:card")).toEqual("summary_large_image"),
    );
  });
  ...
  it("has default author", async () => {
    render(<SEO />);
    await waitFor(() =>
      expect(getMetaTagByName("author")).toEqual("info@site.example"),
    );
  });
  ...
  it("uses custom author", async () => {
    ...
    await waitFor(() =>
      expect(getMetaTagByName("author")).toEqual("contact@site.example"),
    );
  });
  ...
  it("defaults robots to index and follow", async () => {
    render(<SEO />);
    await waitFor(() =>
      expect(getMetaTagByName("robots")).toEqual("index, follow"),
    );
  });
  ...
  it("uses custom robots instruction", async () => {
    ...
    await waitFor(() =>
      expect(getMetaTagByName("robots")).toEqual("noindex, nofollow"),
    );
  });
  ...
  it("has default keywords", async () => {
    render(<SEO />);
    await waitFor(() =>
      expect(getMetaTagByName("keywords")).toEqual("example, keywords"),
    );
  });
  ...
  it("uses custom keywords", async () => {
    ...
    await waitFor(() =>
      expect(getMetaTagByName("keywords")).toEqual("other, keywords"),
    );
  });
  ...
  it("supports ad-hoc custom meta", async () => {
    ...
    await waitFor(() =>
      expect(getMetaTagByName("referrer")).toEqual("same-origin"),
    );
  });
  ...
  it("supports ad-hoc custom links", async () => {
    render(
      <SEO
        links={[{ rel: "me external", href: "https://twitter.com/sample" }]}
      />,
    );
    await waitFor(() =>
      expect(getLinkTagByRel("me external")).toEqual(
